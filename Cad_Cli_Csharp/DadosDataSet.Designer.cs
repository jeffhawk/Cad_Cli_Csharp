...
namespace Cad_Cli_Csharp.DadosDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [clientes] ([CPF], [Nome], [Endereco], [Telefone]) VALUES (@CPF, @Nom" +
                "e, @Endereco, @Telefone);\r\nSELECT Id, CPF, Nome, Endereco, Telefone FROM cliente" +
                "s WHERE (CPF = @CPF)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [clientes] SET [CPF] = @CPF, [Nome] = @Nome, [Endereco] = @Endereco, [Telefone] = @Telefone WHERE (([Id] = @Original_Id) AND ([CPF] = @Original_CPF) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT Id, CPF, Nome, Endereco, Telefone FROM clientes WHERE (CPF = @CPF)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Cad_Cli_Csharp.Properties.Settings.Default.DadosConnectionString;
        }
        ...
        public virtual DadosDataSet.clientesDataTable GetDataBy(string CPF) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((CPF == null)) {
                this.Adapter.SelectCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DadosDataSet.clientesDataTable GetDataBy1(string nome) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((nome == null)) {
                this.Adapter.SelectCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DadosDataSet.clientesDataTable GetDataBy2() {
            this.Adapter.SelectCommand = this.CommandCollection[4];
            DadosDataSet.clientesDataTable dataTable = new DadosDataSet.clientesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(int Original_Id, string Original_CPF, string Original_Nome, string Original_Endereco, string Original_Telefone) {
        ...
        public virtual int Update(string CPF, string Nome, string Endereco, string Telefone, int Original_Id, string Original_CPF, string Original_Nome, string Original_Endereco, string Original_Telefone) {
            if ((CPF == null)) {
                throw new global::System.ArgumentNullException("CPF");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Endereco, string Telefone, int Original_Id, string Original_CPF, string Original_Nome, string Original_Endereco, string Original_Telefone) {
            return this.Update(Original_CPF, Nome, Endereco, Telefone, Original_Id, Original_CPF, Original_Nome, Original_Endereco, Original_Telefone);
        }
